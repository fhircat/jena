...
public interface SemanticActionPlugin extends Plugin {
    ...
    boolean evaluateTripleExpr(SemAct semAct, TripleExpr tripleExpression, Collection<Triple> triples);

    boolean evaluateShapeExpr(SemAct semAct, ShapeExpr shapeExpr, Node focus);
}
