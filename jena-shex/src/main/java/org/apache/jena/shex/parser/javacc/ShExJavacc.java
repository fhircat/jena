...
// Check precedence
  ...
  final public void numericFacet() throws ParseException {
                        String range; Token t; Node numLit; String lenStr;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case MININCLUSIVE:
    case MINEXCLUSIVE:
    case MAXINCLUSIVE:
  ...
  final public String numericRange() throws ParseException {
                          Token t;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case MININCLUSIVE:
  ...
  final public String numericLength() throws ParseException {
                           Token t;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case TOTALDIGITS:
...
// ---- Improvement for LL(1)
  final public TripleExpression tripleExpression() throws ParseException {
                                        int idx;
  ...
  final public void tripleExpressionClause() throws ParseException {
                                  int idx;
...
// ----
  ...
  final public void tripleConstraint(Node label) throws ParseException {
                                      Node p; int idx; boolean reverse = false; Cardinality cardinality = null; List<SemAct> semActs;
  ...
  final public Cardinality cardinality() throws ParseException {
    ...
    default:
      ...
      {if (true) return cardinalityRange(token.image, token.beginLine, token.beginColumn);}
    throw new Error("Missing return statement in function");
  }
...
// }
  ...
  final public void valueExclusion() throws ParseException {
                          String iriStr = null; String lang = null; Node lit = null; boolean isStem = false;
...
//     <MINUS> iri() (<TILDE>)?
// }
  final public void iriRange() throws ParseException {
                    String iriStr; boolean seenTilde = false; boolean haveSet = false;
      startIriRange();
    iriStr = iri();
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case TILDE:
...
// }
  final public void literalRange() throws ParseException {
                        Node lit; boolean seenTilde = false; boolean haveSet = false;
      startLiteralRange();
    lit = literal();
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case TILDE:
...
// Better as original?
  ...
  final public void langRangeLANGTAG() throws ParseException {
                            String lang = null; boolean seenTilde = false; boolean haveSet = false;
    jj_consume_token(LANGTAG);
               lang = token.image;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case TILDE:
  ...
  final public void langRangeAT() throws ParseException {
                       boolean haveSet = false; String lang = null; boolean seenTilde = false;
    jj_consume_token(AT);
    jj_consume_token(TILDE);
  ...
  final public List<SemAct> semanticActions() throws ParseException {
  ...
  final public Node predicate() throws ParseException {
    ...
    case PNAME_LN:
      s = iri();
                  {if (true) return createURI(s, token.beginLine, token.beginColumn);}
      break;
    case RDF_TYPE:
      jj_consume_token(RDF_TYPE);
                   {if (true) return nRDFtype;}
      break;
    default:
      jj_la1[79] = jj_gen;
      jj_consume_token(-1);
  ...
  final public Node shapeExprLabel() throws ParseException {
                          Node n ;
    //iri() | blankNode()
        n = _label();
                   {if (true) return n ;}
  ...
  final public Node tripleExprLabel() throws ParseException {
                           Node n;
    //iri() | blankNode()
        n = _label();
                   {if (true) return n ;}
  ...
  final public Node _label() throws ParseException {
                  String n;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case IRIref:
    case PNAME_NS:
    case PNAME_LN:
      n = iri();
        {if (true) return createURI(n, token.beginLine, token.beginColumn);}
      break;
    case BLANK_NODE_LABEL:
      n = blankNode();
        {if (true) return createBNode(n, token.beginLine, token.beginColumn);}
      break;
    default:
      jj_la1[80] = jj_gen;
      jj_consume_token(-1);
...
// ------------------------- Terms
  ...
  final public Node numericLiteral() throws ParseException {
    ...
    case INTEGER:
      t = jj_consume_token(INTEGER);
      {if (true) return createLiteralInteger(t.image, token.beginLine, token.beginColumn) ;}
      break;
    case DECIMAL:
      t = jj_consume_token(DECIMAL);
      {if (true) return createLiteralDecimal(t.image, token.beginLine, token.beginColumn) ;}
      break;
    case DOUBLE:
      t = jj_consume_token(DOUBLE);
      {if (true) return createLiteralDouble(t.image, token.beginLine, token.beginColumn) ;}
      break;
    default:
      jj_la1[82] = jj_gen;
      jj_consume_token(-1);
  ...
  final public Node rdfLiteral() throws ParseException {
                      Node n; Token t; String lex; String dt = null;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case LANG_STRING_LITERAL1:
    case LANG_STRING_LITERAL2:
    case LANG_STRING_LITERAL_LONG1:
    ...
    case STRING_LITERAL_LONG2:
      ...
      {if (true) return createLiteral(lex, null, dt, t.beginLine, t.beginColumn) ;}
      break;
    default:
      jj_la1[84] = jj_gen;
      jj_consume_token(-1);
  ...
  final public String string() throws ParseException {
    ...
    default:
      ...
      {if (true) return unescapeStr(lex,  t.beginLine, t.beginColumn) ;}
    throw new Error("Missing return statement in function");
  }

  final public Node langString() throws ParseException {
                      Token t; Node n;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case LANG_STRING_LITERAL1:
      t = jj_consume_token(LANG_STRING_LITERAL1);
                                       {if (true) return langStringLiteral(1, t.image, t.beginLine, t.beginColumn);}
      break;
    case LANG_STRING_LITERAL2:
    ...
    case LANG_STRING_LITERAL_LONG2:
      t = jj_consume_token(LANG_STRING_LITERAL_LONG2);
                                       {if (true) return langStringLiteral(3, t.image, t.beginLine, t.beginColumn);}
      break;
    case LANG_STRING_LITERAL_LONG1:
...
// ---- Shape Map
  final public void UnitShapeMap() throws ParseException {
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case BOM:
      jj_consume_token(BOM);
      break;
  ...
  final public void shapeAssociation() throws ParseException {
                            Node n = null ; Triple t = null ; Node label;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case TRUE:
    case FALSE:
    case IRIref:
...
//   )
// }
  final public Node subjectTerm() throws ParseException {
                       String s;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case IRIref:
    case PNAME_NS:
    ...
    case BLANK_NODE_LABEL:
      s = blankNode();
        {if (true) return createBNode(s, token.beginLine, token.beginColumn);}
      break;
    default:
      jj_la1[95] = jj_gen;
      jj_consume_token(-1);
  ...
  final public Node objectTerm() throws ParseException {
                      Node n;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case IRIref:
    case PNAME_NS:
  ...
  final public Triple triplePattern() throws ParseException {
                           Node s = null; Node p = null ; Node o = null ; Token tok;
    ...
    jj_consume_token(RBRACE);
    {if (true) return createTriple(s, p, o, tok.beginLine, tok.beginColumn);}
    throw new Error("Missing return statement in function");
  }

  final public Node shapeSpec() throws ParseException {
                     String x;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case AT:
      jj_consume_token(AT);
      ...
      case PNAME_LN:
        x = iri();
                        {if (true) return createURI(x, token.beginLine, token.beginColumn);}
        break;
      case START:
        jj_consume_token(START);
                      {if (true) return startNode;}
        break;
      default:
        jj_la1[100] = jj_gen;
        jj_consume_token(-1);
